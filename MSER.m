...
colorImage = imread("MCG7722.png");
I = im2gray(colorImage);
colorImage = imadjust(I);
%colorImage = histeq(I);
%colorImage = imsharpen(colorImage, "Radius",5,"Amount",2);


figure, 
subplot(1,2,1),imshow(colorImage), title('Original Natural Image');
subplot(1,2,2),imshow(I), title('After Image');

% Detect MSER regions.
[mserRegions, mserConnComp] = detectMSERFeatures(I,'RegionAreaRange',[200 6000],'ThresholdDelta',4);

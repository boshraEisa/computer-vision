...
colorImage = imread("PEN15.jpg");
%colorImage = imsharpen(colorImage, "Radius",2,"Amount",2);
...
% Detect MSER regions.
[mserRegions, mserConnComp] = detectMSERFeatures(I,'RegionAreaRange',[50 4000],'ThresholdDelta',4);
